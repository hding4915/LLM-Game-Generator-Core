Source: doc/programming_guide/gui/style.rst
...
- :py`~arcade.gui.UITextureButton`
- :py`~arcade.gui.UIFlatButton`
- :py`~arcade.gui.UISlider`


# Basic Usage

This section will style a :py`~arcade.gui.UIFlatButton` as an example. You
...
:py`~arcade.gui.UIFlatButton`, you can access this attribute via
