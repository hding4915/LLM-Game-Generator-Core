Source: doc/programming_guide/keyboard.rst
...
of `arcade.Window`. The arcade.key <key> module contains
...
Constants for each of these bits are defined in arcade.key <key>:
...
arcade.key <key> to :ref:`track press and release events
