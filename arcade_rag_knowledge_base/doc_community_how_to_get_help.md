Source: doc/community/how_to_get_help.rst
...
#. The problem you're having, with any
   error output formatted properly <help-sharing-with-markdown-terminal>
#. Your code, with
   proper formatting <help-sharing-with-markdown-python>
#. Which version of Arcade <help-basic-environment-info> you're
...
#. Pasting into Discord <help-sharing-with-markdown-python> for
   small amounts of code
#. Using a code hosting service <help-sharing-with-code-hosting>
   for 1 or more files
...
installed arcade <install> and activated your
virtual environment.
...
* Not installing Arcade <install> successfully
