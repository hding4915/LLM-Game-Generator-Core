Source: doc/tutorials/platform_tutorial/step_02.rst
...
What is the code doing?
    ...
    For more information checkout resources

Sprites
~~~~~~~

While the texture data is now 'saved' into the class as a variable. We can't use it as is, we need to convert it
to a Sprite. If Textures are an instance of a particular image from a file, then `arcade.Sprite` is an
...
* Explore the documentation for the `arcade.Texture` class
* Explore the documentation for the `arcade.Sprite` class
