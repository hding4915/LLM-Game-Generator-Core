Source: Arcade 2.6.17 doc/examples/platform_tutorial/step_02.rst
...
down 50% for a 64x64 sprite.
    ...
    The arcade library has a few built-in resources so we can run
...
shown in the image at the top of this page.
    ...
    * Use different images for sprites (see resources for the build-in images, or use
      your own images.)
