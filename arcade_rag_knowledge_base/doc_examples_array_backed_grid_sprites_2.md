Source: Arcade 2.6.17 doc/examples/array_backed_grid_sprites_2.rst
...
* array_backed_grid_buffered - slow and uses buffered shapes
* array_backed_grid_sprites_1 - super-fast and uses sprites. Resyncs to number grid in one function call
* array_backed_grid_sprites_2 - (This program) super-fast and uses sprites. Keeps a second 2D grid of sprites to match 2D grid of numbers
