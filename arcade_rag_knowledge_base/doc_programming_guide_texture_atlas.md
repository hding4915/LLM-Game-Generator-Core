Source: doc/programming_guide/texture_atlas.rst
...
:py`arcade.DefaultTextureAtlas` is where your textures eventually end up
...
This is an instance of :py`arcade.ArcadeContext` where the low
...
do this by modifying the Pillow texture in the :py`arcade.Texture`
