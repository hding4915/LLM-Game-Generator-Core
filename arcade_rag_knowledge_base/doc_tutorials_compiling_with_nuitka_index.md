Source: doc/tutorials/compiling_with_nuitka/index.rst
...
about Python and its working :(. Though bundle_into_redistributable *is* a good option, the 
...
For this tutorial, we will use the code from platformer_tutorial. 
...
This will copy the whole folder named ``assets`` at the specified location to the root of the executable.
    ...
    If you want to use a custom resource handles and Nuitka's one-file build see: resource_handles_one_file_builds.
