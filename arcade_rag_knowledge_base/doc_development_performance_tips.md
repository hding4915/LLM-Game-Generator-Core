Source: Arcade 2.6.17 doc/development/performance_tips.rst
...
`arcade.ShapeElement` lists where you batch together the drawing commands.
...
Sprite drawing is done in batches via the `arcade.SpriteList` class.
...
text objects. See drawing_text_objects.