Source: doc/tutorials/platform_tutorial/step_08.rst
...
hits one, we want to remove it from the screen. To do this we will use `arcade.check_for_collision_with_list` function.
...
We use this `arcade.BasicSprite.remove_from_sprite_lists` function in order to ensure our Sprite is completely
