Source: doc/tutorials/platform_tutorial/step_10.rst
...
In this chapter we will cover using `arcade.Text` objects, as well as a technique for using two cameras
...
`arcade.draw_text` function. This is a simple function that you can put directly in ``on_draw`` to draw a string of text.

This function however, is not very performant, and there is a better way. We will instead use `arcade.Text` objects. These have many
