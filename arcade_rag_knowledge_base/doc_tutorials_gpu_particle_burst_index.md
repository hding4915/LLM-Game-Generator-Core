Source: Arcade 2.6.17 doc/tutorials/gpu_particle_burst/index.rst
...
which we defined above in our open_gl_shaders
...
* fragment_shader |larr| Where we are right now
* vertex_shader_v1 |larr| Where we are right now
* gpu_particle_burst_02 |larr| Where we are right now
* gpu_particle_burst_02_diff |larr| What we changed to get here
...
* vertex_shader_v2 |larr| Where we are right now
* vertex_shader_v2_diff |larr| What we changed to get here
* gpu_particle_burst_03 |larr| Where we are right now
* gpu_particle_burst_03_diff |larr| What we changed to get here
...
* gpu_particle_burst_04 |larr| Where we are right now
* gpu_particle_burst_04_diff |larr| What we changed to get here
...
* gpu_particle_burst_05 |larr| Where we are right now
* gpu_particle_burst_05_diff |larr| What we changed to get here
...
* vertex_shader_v3 |larr| Where we are right now
* vertex_shader_v3_diff |larr| What we changed to get here
* gpu_particle_burst_06 |larr| Where we are right now
* gpu_particle_burst_06_diff |larr| What we changed to get here
...
* vertex_shader_v4 |larr| Where we are right now
* vertex_shader_v4_diff |larr| What we changed to get here
* gpu_particle_burst_07 |larr| Where we are right now
* gpu_particle_burst_07_diff |larr| What we changed to get here
...
* vertex_shader_v5 |larr| Where we are right now
* vertex_shader_v5_diff |larr| What we changed to get here
