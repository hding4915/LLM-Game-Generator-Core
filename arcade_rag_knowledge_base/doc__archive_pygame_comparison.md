Source: doc/_archive/pygame_comparison.rst
...
Arcade also has two sprite classes available. The full-featured :py`arcade.Sprite` class
and the smaller and faster :py`arcade.BasicSprite` class. If you don't need collision detection
