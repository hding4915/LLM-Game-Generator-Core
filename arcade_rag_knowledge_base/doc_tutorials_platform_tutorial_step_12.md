Source: doc/tutorials/platform_tutorial/step_12.rst
...
We'll explore how to load maps from Tiled in this tutorial using Arcade's built-in `arcade.TileMap` class
