Source: doc/get_started/arcade_book.rst
...
how-to-get-help for more information.

## Tutorials

If you are already familiar with basic Python programming, follow the
platformer_tutorial as a quick way to get up and running.
...
* Basic Drawing Commands -
  ...
  * ShapeElementLists - Batch together thousands
    ...
    `arcade.shape_list.ShapeElementList`. See examples in
    shape-element-lists.
...
* Physics Engines
  ...
  * PhysicsEngineSimple - Platformer tutorial platformer_part_three,
  ...
  * PhysicsEnginePlatformer - From the platformer tutorial: platformer_part_four,
