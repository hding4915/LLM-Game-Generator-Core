Source: doc/example_code/performance_statistics.rst
...
`arcade.print_timings` to print out the count and average time for
...
See perf_info_api for more information about the performance api.
